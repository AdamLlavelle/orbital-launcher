...
- [ ] step-01 — Re-enable Forge launching (fix written, untested) ← CURRENT
- [x] step-02 — Ship v0.2.0-beta (premades + wizard; Forge still gated) — 2026-07-09
- [ ] step-03 — TBD by Adam. Parked ideas: auto-update (electron-updater),
      per-profile RAM, skin viewer, modpack import, macOS/Linux builds
